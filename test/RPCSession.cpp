...
void RPCSession::test_setChainParams(vector<string> const& _accounts)
{
	...
	static string const c_configString = R"(
	{
		...
		"accounts": {
			"0000000000000000000000000000000000000001": { "von": "1", "precompiled": { "name": "ecrecover", "linear": { "base": 3000, "word": 0 } } },
			"0000000000000000000000000000000000000002": { "von": "1", "precompiled": { "name": "sha256", "linear": { "base": 60, "word": 12 } } },
			"0000000000000000000000000000000000000003": { "von": "1", "precompiled": { "name": "ripemd160", "linear": { "base": 600, "word": 120 } } },
			"0000000000000000000000000000000000000004": { "von": "1", "precompiled": { "name": "identity", "linear": { "base": 15, "word": 3 } } },
			"0000000000000000000000000000000000000005": { "von": "1", "precompiled": { "name": "modexp" } },
			"0000000000000000000000000000000000000006": { "von": "1", "precompiled": { "name": "alt_bn128_G1_add", "linear": { "base": 500, "word": 0 } } },
			"0000000000000000000000000000000000000007": { "von": "1", "precompiled": { "name": "alt_bn128_G1_mul", "linear": { "base": 40000, "word": 0 } } },
			"0000000000000000000000000000000000000008": { "von": "1", "precompiled": { "name": "alt_bn128_pairing_product" } }
		}
	}
	)";
	...
	for (auto const& account: _accounts)
		config["accounts"][account]["von"] = "0x100000000000000000000000000000000000000000";
